...
@Component({
  selector: 'ng-http-store-child-two',
  imports: [JsonPipe],
  templateUrl: './http-store-child-two.component.html',
  styleUrl: './http-store-child-two.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class HttpStoreChildTwoComponent {
