...
Данный модуль предоставляет возможность автоматизированного взаимодействия с *REST API backend* при помощи набора **CRUD** запросов. Внутренняя реализация использует `HttpClient` пакета `@angular/common/http`.
